...
if (iconMenu != null) {
	...
	iconMenu.addEventListener("click", function (e) {
		if (unlock) {
			body_lock(delay);
			menuBody.querySelectorAll(".nav__link a").forEach(link => {
...
// function checkEmailInputs(selector) {
// 	const emailInputs = document.querySelectorAll(selector);
// 	// const validValue = /^[A-Z0-9._%+-]+@[A-Z0-9-]+.+.[A-Z]{2,4}$/i;
// 	const validValue = /^\S+@\S+$/i;

// 	emailInputs.forEach(item => {
// 		return validValue.test(item.value);
...
const message = {
	...
	uncorrect: 'Введите корректный email',
...
form.forEach(item => {
	item.addEventListener('submit', (e) => {
		...
		postData('server.php', formData)
			.then(res => {
				console.log(res);
				//  if (checkEmailInput('input[name="email"]')) {
				// 	statusMessage.textContent = message.success; 
				//  } else {
				// 	 statusMessage.textContent = message.uncorrect;
				//  }
				statusMessage.textContent = message.success;
			})
...
const swiper = new Swiper(".selection__slider", {
    ...
    slidesPerView: 2,
    pagination: {
      el: ".selection__slider-pagination",
      type: "fraction",
    },
    navigation: {
      nextEl: ".selection__slider-next"
    },
    breakpoints: {
      992: {
        slidesPerView: 2,
  ...
  const bigSwiper = new Swiper(".inspiration__slider", {
    loop: true,
    spaceBetween: 30,
    slidesPerView: 3,
    pagination: {
      el: ".inspiration-bottom__pagination",
      type: "fraction",
    },
    navigation: {
      nextEl: ".inspiration__slider-next",
      prevEl: ".inspiration__slider-prev"
    },
    breakpoints: {
      992: {
        slidesPerView: 2,
